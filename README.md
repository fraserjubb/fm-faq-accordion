# FM - FAQ Accordion Solution - Fraser Jubb

This is a solution to [this challenge on Frontend Mentor](https://www.frontendmentor.io/challenges/faq-accordion-wyfFdeBwBz).
...
- Live Site URL: [Click Here](https://fm-faqaccordion-fraser.netlify.app/)
